...
- 🧠 **Reasoning-агенты через API** — встроенные `moa` / `sc` / `debate` / `deep_search`, без LangChain/LangGraph. Ставишь `model: "moa"` — получаешь ансамбль из 25 моделей, ставишь `deep_search` — research-агент с web-search.
