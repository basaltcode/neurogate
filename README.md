...
- 🛠️ **Backend для AI-кодеров** — Claude Code, Cursor, Codex, OpenCode, Continue, Cline, Zed AI и тд. — любой из них, к которому есть доступ. В настройках клиента: `base_url = http://your-neurogate:8765/v1`. Платный API заменяется на твой бесплатный.
